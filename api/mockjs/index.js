module.exports = (function() {
              ...
              Handler.gen = function(template, name, context) {
                ...
                context = {
                  ...
                  templateCurrentContext:
                    context.templateCurrentContext || template,
                  // 最终值的根
                  ...
                  if (!options.rule.parameters) {
                    ...
                    if (
                      ...
                      if (options.rule.parameters[2]) {
                        ...
                        options.template.__order_index += +options.rule
                          .parameters[2];
                  ...
                  if (cur !== undefined) {
                    ...
                    max =
                      typeof max !== 'undefined' && !isNaN(max)
                        ? parseInt(max, 10)
                        : 1;
                    return Math.random() > (1.0 / (min + max)) * min
                      ? !cur
                      : cur;
                  }
	    ...
	    */
	             ...
	             */
                    ...
                    var width = parseInt(size[0], 10),
                      ...
                      background = this._brandColors[
                        this.pick(this._brandNames())
                      ],
                      foreground = '#FFF',
                      text_height = 14,
                      font = 'sans-serif';
	...
	*/
              ...
              module.exports = {
                ...
                hex2rgb: function(
                  ...
                  a =
                    ('0x' +
                      a.slice(1).replace(a.length > 4 ? a : /./g, '$&$&')) |
                    0;
            ...
            /***/ function(module, exports) {
              ...
              function CaptureGroup(n) {
                Group.call(this, 'capture-group'),
                  (this.index =
                    cgs[this.offset] || (cgs[this.offset] = index++)),
                  (this.body = n);
              }
                  ...
                  switch (schema.type) {
                    ...
                    case 'array':
                      if (schema.rule.parameters) {
                        // name|count: array
                        if (
                          schema.rule.min !== undefined &&
                          schema.rule.max === undefined
                        ) {
                  ...
                  for (var i = 0; i < keys.length; i++) {
                    result.push.apply(
                      ...
                      this.diff(
                        (function() {
                          var property;
                          Util.each(schema.properties, function(
                            item /*, index*/
                          ) {
              ...
              var Assert = {
                message: function(item) {
                  return (
                    ...
                    .replace(
                      '{path}',
                      (Util.isArray(item.path) && item.path.join('.')) ||
                        item.path
                    )
	     ...
	     */
              ...
              Util.extend(MockXMLHttpRequest.prototype, {
                ...
                send: function send(data) {
                  ...
                  this.dispatchEvent(
                    new Event('loadstart' /*, false, false, this*/)
                  );
                  ...
                  function done() {
                    ...
                    that.dispatchEvent(
                      new Event('load' /*, false, false, that*/)
                    );
                    that.dispatchEvent(
                      new Event('loadend' /*, false, false, that*/)
                    );
                  }
                },
              ...
              function createNativeXMLHttpRequest() {
                var isLocal = (function() {
                  ...
                  var ajaxLocParts =
                    rurl.exec(ajaxLocation.toLowerCase()) || [];
              ...
              function find(options) {
                for (var sUrlType in MockXMLHttpRequest.Mock._mocked) {
                  ...
                  if (
                    ...
                    (!item.rtype ||
                      match(item.rtype, options.type.toLowerCase()))
                  ) {
  ...
  return __REQUIRE__(1582820827701);
})();
