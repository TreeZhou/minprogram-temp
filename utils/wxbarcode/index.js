module.exports = (function() {
  ...
  __DEFINE__(
    ...
    function(modId) {
      var map = { './demo/utils': 1583229288923 };
  ...
  __DEFINE__(
    ...
    function(require, module, exports) {
      ...
      //todo : 修改了源码，增加了回调cb
      function qrc(id, code, width, height, cb) {
    ...
    function(modId) {
      var map = { './barcode': 1583229288924, './qrcode': 1583229288925 };
      return __REQUIRE__(map[modId], modId);
    }
  );
  __DEFINE__(
    ...
    function(require, module, exports) {
      ...
      function codeValue(chr1, chr2) {
        if (typeof chr2 == 'undefined') {
          ...
          return parseInt(
            String.fromCharCode(chr1) + String.fromCharCode(chr2)
          );
        }
      }
      ...
      var QR = (function() {
        ...
        function genframe(instring) {
          ...
          do {
            ...
            k =
              datablkw * (neccblk1 + neccblk2) + neccblk2 - 3 + (version <= 9);
            if (t <= k) break;
          } while (version < 40);
          ...
          v =
            datablkw +
            (datablkw + eccblkwid) * (neccblk1 + neccblk2) +
            neccblk2;
  ...
  return __REQUIRE__(1583229288922);
})();
