...
Component({
  ...
  methods: {
    ...
    getDateObj(index) {
      return this.data.days[index].timeStamp;
    },
    dateSelectAction: function(e) {
      ...
      if (this.data.lastDay != null) {
        this.setData({
          todayIndex: null,
          lastDay: null,
          todayIndexTimeStamp: null,
          lastDayTimeStamp: null
        });
      }
      if (
        this.data.todayIndex == null ||
        this.data.todayIndexTimeStamp > this.getDateObj(cur_day)
      ) {
        this.setData({
          todayIndex: cur_day,
          todayIndexTimeStamp: this.getDateObj(cur_day)
        });
        this.setData({
          firstInit: true
        });
        ...
        this.setData({
          lastDayTimeStamp: this.getDateObj(cur_day),
          lastDay: cur_day
        });
        ...
        this.triggerEvent('datechange', {
          startDate: this.data.todayIndexTimeStamp,
          endDate: this.data.lastDayTimeStamp
        });
      }
    ...
    setNowDate: function() {
      ...
      this.setData({
        ...
        weeks_ch,
        todayIndex,
        todayIndexTimeStamp: this.getDateObj(todayIndex)
      });
    },
